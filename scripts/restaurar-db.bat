...
echo.
echo 3. Restaurando esquema y todos los datos desde scripts\backup_disciplina.sql...
docker exec -i disciplina-postgres psql -U admin_disciplina -d disciplina_db < "%~dp0backup_disciplina.sql"
